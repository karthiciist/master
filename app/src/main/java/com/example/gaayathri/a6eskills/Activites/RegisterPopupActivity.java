        ...
        sendOtp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(RegisterPopupActivity.this, e.toString(), Toast.LENGTH_SHORT).show();
                }
                ...
                try {
                    ...
                    if (code.equals(1004)) {
                        ...
                        Toast.makeText(RegisterPopupActivity.this, "Mobile number not registered", Toast.LENGTH_SHORT).show();
                    }

                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(RegisterPopupActivity.this, "Check credentials and Internet Connection..!", Toast.LENGTH_SHORT).show();
                } catch (JSONException ej) {
                    ej.printStackTrace();
                    //Toast.makeText(RegisterPopupActivity.this, ej.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
