...
public class SkillsActivity extends AppCompatActivity implements SkillClickListoner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Skills> input = new ArrayList<>();

        Skills skills_1 = new Skills();
        skills_1.setId(1);
        skills_1.setName("Data Science");
        input.add(skills_1);

        Skills skills_2 = new Skills();
        skills_2.setId(12);
        skills_2.setName("Data Engineering");
        input.add(skills_2);

        Skills skills_3 = new Skills();
        skills_3.setId(25);
        skills_3.setName("Devops");
        input.add(skills_3);

        Skills skills_4 = new Skills();
        skills_4.setId(42);
        skills_4.setName("Analytics and Reporting");
        input.add(skills_4);

        Skills skills_5 = new Skills();
        skills_5.setId(49);
        skills_5.setName("Infrastructure/Security/Identity Management");
        input.add(skills_5);

        Skills skills_6 = new Skills();
        skills_6.setId(71);
        skills_6.setName("Automation");
        input.add(skills_6);


        mAdapter = new MainSkillAdoptor(input, skillClickListoner);
